...
job_topdir = ROOT + 'eqnet/jobs/reconstruction-control/jobs019a/'

dirlist = os.listdir(job_topdir)
loss = []

# READ FROM FILES
xnames = ['batch_size', 'h_dim', 'p_dropout_hidden', 'num_h', 'num_epochs', 'learn_rate', 'p_dropout_in']
var2plot = 'p_dropout_hidden'
