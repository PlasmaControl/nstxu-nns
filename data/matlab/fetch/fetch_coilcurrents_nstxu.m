...
% 
% shot = 204069;
% tags = strcat('.ANALYSIS:', {'IOH', 'IPF1AU', 'IPF2U', 'IPF3U', ...
%   'IPF5', 'IPF3L', 'IPF2L', 'IPF1AL'});
% 
% tree = 'engineering';
% times = [];
% 
% coils = fetch_coilcurrents_nstxu(shot, []);
% 
% for i = 1:length(tags)
% 
%   signal = mds_fetch_signal(shot, tree, times, tags{i});
% 
%   figure
%   plot(signal.times, signal.sigs, '-b')
%   hold on
%   title(circ.keep_coils{i})
%   hold on
%   plot(coils.times, coils.icx(circ.ikeep(i),:), '--r');
%   xlim([0 1.5])
% end
% 
